...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            case 'sc': {
                anu = `*WhatsApp Developer bot:*
wa.me/6285795163587

*Recode By : IhsanNurohman*
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://youtube.com/channel/UCcaBU1RG3kOGL3f4_Dd7Y-A'
                                }
                                }, {
                                urlButton: {
...
let btn = [{
            ...
            case 'menu': case 'help': case '?': {
                anu = `${ucapanWaktu} Beban🙏\n\nI Am ${global.namabot}, Jika menemukan bug/eror segera lapor owner agar dapat segera di fix`
                let btn = [{
                                urlButton: {
                                    displayText: 'My Youtube️',
                                    url: 'https://youtube.com/channel/UCcaBU1RG3kOGL3f4_Dd7Y-A'
