...
_sewa.expiredCheck(xavior, sewa)
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await xavior.setStatus(`${''} | Runtime : ${runtime(uptime)}`)
...
*Recode By : rryuex*
https://github.com/IhsanNurohman`
let btn = [{
                                urlButton: {
                                    displayText: 'Source Code',
                                    url: 'https://github.com/IhsanNurohman'
                                }
                            }]
                         let setbot = db.data.settings[botNumber]
                        if (setbot.templateImage) {
                        xavior.send5ButImg(m.chat, anu, '', global.thumb, btn, global.thumb)
                        } else if (setbot.templateGif) {
                        xavior.send5ButGif(m.chat, anu, '', global.visoka, btn, global.thumb)
                        } else if (setbot.templateVid) {
                        xavior.send5ButVid(m.chat, anu, '', global.visoka, btn, global.thumb)
                        } else if (setbot.templateMsg) {
                        xavior.send5ButMsg(m.chat, anu, '', btn)
                        } else if (setbot.templateLocation) {
                        xavior.send5ButLoc(m.chat, anu, '', global.thumb, btn)
                        }
                     }
            break
            case 'chat': {
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, jawab, '', m, {mentions: ments})
            }
            break
            case 'jadian': {
            if (!m.isGroup) throw mess.group
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, jawab, '', m, {mentions: menst})
            }
            break
            case 'react': {
                if (!isCreator) throw mess.owner
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            break
               case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Group`, '', m)
            ...
            case 'editinfo': {
             ...
             let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Edit Info`, '', m)
            ...
            case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mode Antilink`, '', m)
                }
             }
             break
             case 'mute': {
                ...
                m.reply(`${''} telah di unmute di group ini !`)
                 ...
                 let buttons = [
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `Mute Bot`, '', m)
                }
             }
             break
            ...
            case 'ephemeral': {
                ...
                xavior.sendListMsg(m.chat, `Please select the following Ephemeral Options List !`, '', `Hello Admin ${groupMetadata.subject}`, `Click Here`, sections, m)
                }
            }
            break
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: 'Grup bot️',
                                    url: 'https://chat.whatsapp.com/EQJ7chmSUSAFqnAF8NTLkH'
                                }
                                }, {
                                urlButton: {
                      ...
                      xavior.send5ButImg(i, txt, '', global.thumb, btn)
                    }
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                      ...
                      let txt = `「 Broadcast Bot 」\n\n${text}`
                      xavior.send5ButImg(yoi, txt, '', global.thumb, btn)
		}
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            xavior.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${''}.mp3`}, { quoted : m })
            }
            break
	    ...
	    case 'anonymous': {
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `\`\`\`Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda\`\`\``, '', m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await xavior.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, '', m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await xavior.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, '', m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await xavior.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, '', m)
                }
                break
            }
...
⭔ Detail: ${detail}`
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                xavior.sendListMsg(m.chat, `Please select the menu you want to change!`, '', `Hello Owner !`, `Click Here`, sections, m)
                }
            }
            break
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/6285795163587?text=SEWABOT
╰────
╭─[ *PAYMENT* ]
├  DANA
├  GOPAY
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/6285795163587?text=JADIBOT
╰────
╭─[ *PAYMENT* ]
├  DANA
├  GOPAY
...
let btn = [{
            ...
            break
case 'gopay': {
                m.reply('NOPE GOPAY: 085795163587')
            }
            break
case 'dana': {
                m.reply('NOPE DANA: 085795163587')
            }
            break
case 'pulsa': {
m.reply('085795163587 ( indosat ) ')
}
break
// Button List
case 'command':{
let template = await generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                listMessage :{
                    title: `Silahkan ${pushname} di cari`,
                    description: "",
                    buttonText: "MENU",
                    footerText: "",
                    ...
                    sections: [{
							...
							},
							{
								...
								"rows": [
									...
									{
										"title": "Search Menu",
										"description": "Lu Bisa Cari anu Disini 🗿",
...
let btn = [{
            ...
            case 'menu': case 'help': case '?': {
                anu = `${ucapanWaktu} 🙏\n\nI  ${global.namabot}, Newbie <".\n${global.namabot} Bot Ini Masih Tahap Pengembangan.\nJika Menemukan Bug/Eror Harap Lapor Owner \n gunakan cmd .Allmenu jika menu tidak muncul`
                let btn = [{
                                urlButton: {
                                    displayText: 'Grup bot️',
                                    url: 'https://chat.whatsapp.com/EQJ7chmSUSAFqnAF8NTLkH'
